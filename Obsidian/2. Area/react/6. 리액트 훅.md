...
3. [[#useEffect 훅|useEffect 훅]]
	...
	4. [[#useEffect 훅#리액트 훅의 생명 주기|리액트 훅의 생명 주기]]
		1. [[#리액트 훅의 생명 주기#컴포넌트 마운트|컴포넌트 마운트]]
			2. [[#컴포넌트 마운트#1. 레이지 초기화|1. 레이지 초기화]]
			3. [[#컴포넌트 마운트#2. 렌더링|2. 렌더링]]
			4. [[#컴포넌트 마운트#3. 가상 DOM 업데이트|3. 가상 DOM 업데이트]]
			5. [[#컴포넌트 마운트#4. LayoutEffect 실행|4. LayoutEffect 실행]]
			6. [[#컴포넌트 마운트#5. 브라우저 DOM 업데이트|5. 브라우저 DOM 업데이트]]
			7. [[#컴포넌트 마운트#6. Effects 실행|6. Effects 실행]]
		2. [[#리액트 훅의 생명 주기#컴포넌트 업데이트|컴포넌트 업데이트]]
			1. [[#컴포넌트 업데이트#1. 렌더링|1. 렌더링]]
			2. [[#컴포넌트 업데이트#2. 가상 DOM 업데이트|2. 가상 DOM 업데이트]]
			3. [[#컴포넌트 업데이트#3. LayoutEffects 클린업|3. LayoutEffects 클린업]]
			4. [[#컴포넌트 업데이트#4. LayoutEffects 실행|4. LayoutEffects 실행]]
			5. [[#컴포넌트 업데이트#5. 브라우저 DOM 업데이트|5. 브라우저 DOM 업데이트]]
			6. [[#컴포넌트 업데이트#6. Effects 클린업|6. Effects 클린업]]
			7. [[#컴포넌트 업데이트#7. Effects 실행|7. Effects 실행]]
		3. [[#리액트 훅의 생명 주기#컴포넌트 언마운트|컴포넌트 언마운트]]
			1. [[#컴포넌트 언마운트#1. LayoutEffects 클린업|1. LayoutEffects 클린업]]
			2. [[#컴포넌트 언마운트#2. Effects 클린업|2. Effects 클린업]]
